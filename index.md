...
archived on the Open Science Framework [here](https://osf.io/3649s/).
...
[^1]: The R package structure was chosen to facilitate the sharing of
    ...
    [this reference book](https://r-pkgs.org/)) is also a good way to
    ensure that the code is well-documented and tested, which matters
