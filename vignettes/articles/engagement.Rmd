...
Every accuracy model on this site carries it, and no gate does: the
[composition](composition.html), [performance](performance.html) and
[joint model](joint-model.html) pages all put `parity_rate` on the arms
that model how well a feature was recalled, and leave it off the arms that
model whether it was recalled at all.
