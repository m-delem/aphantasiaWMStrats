...
Four chains, 2000 iterations each with half discarded as warmup, giving
8000 draws across 571 parameters.
...
**Cross-validation of the primary model.** Model comparison was run on
functional form for one feature ([performance](performance.html) §4) and
on the compositional coordinate, not on the joint model as a whole. With
54 parameters and 86 participants, a LOO comparison against alternatives
would mostly report its own uncertainty.
